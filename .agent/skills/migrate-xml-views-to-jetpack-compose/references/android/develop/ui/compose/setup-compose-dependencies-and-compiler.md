...
> For an example migration, see the [Compose Samples
...
1. In your project's root `build.gradle.kts` file, add the following snippet to the `plugins`
   section.
...
block enables [Compose functionality](https://developer.android.com/develop/ui/compose/tooling) in
Android Studio.
