...
This migration skill is Android View-system specific. Use it as technical migration guidance and
keep TajsOS shell/screen architecture intact when integrating migrated UI.
