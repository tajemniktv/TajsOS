...
- [ ] Postpone frequency
- [ ] Daily / weekly chaos score
- [ ] Backlog pressure metric
- [ ] Execution ratio
...
- [ ] Sleep vs focus sessions
- [ ] Meds taken vs day quality
- [ ] Energy vs number of captures
- [ ] Anxiety vs avoidance patterns
...
- [ ] Project issue board
- [ ] Snippet storage
- [ ] Reference links for research / dev
- [ ] Mod / project relation mapping
- [ ] Task from idea in one tap
...
- [ ] Chaos meter
- [ ] Neglect detector
- [ ] Dead projects cemetery
- [ ] Idea reincubator
- [ ] Mood soundtrack note
- [ ] Context resurrection
- [ ] Memory trace
- [ ] Decision freezer
- [ ] Anti-overengineering mode
