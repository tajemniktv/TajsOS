...
class RepositoryDelegationTest {
    ...
    @Test
    fun getNodesByProjectWithPins_delegatesToNodeDao() = runTest {
        val projectId = 42L
    ...
    @Test
    fun getNodesByProjectWithPins_returnsEmptyListWhenNoNodes() = runTest {
    ...
    @Test
    fun getNodesByProjectWithPins_passesCorrectProjectIdToDao() = runTest {
    ...
    @Test
    fun getNodesByAreaWithPins_delegatesToNodeDao() = runTest {
        val areaId = 10L
    ...
    @Test
    fun getNodesByAreaWithPins_returnsEmptyListWhenNoNodes() = runTest {
    ...
    @Test
    fun getNodesByAreaWithPins_passesCorrectAreaIdToDao() = runTest {
        val fakeDao = FakeNodeDao()
        val repo = buildRepository(fakeDao)
    ...
    @Test
    fun getProjectsByArea_delegatesToNodeDao() = runTest {
        val areaId = 7L
    ...
    @Test
    fun getProjectsByArea_returnsEmptyListWhenNoProjects() = runTest {
    ...
    @Test
    fun getProjectsByArea_passesCorrectAreaIdToDao() = runTest {
        val fakeDao = FakeNodeDao()
        val repo = buildRepository(fakeDao)
    ...
    @Test
    fun getProjectsByArea_multipleProjects_areAllReturned() = runTest {
    ...
    @Test
    fun getNodesByProject_delegatesToNodeDao() = runTest {
    ...
    @Test
    fun getNodesByArea_delegatesToNodeDao() = runTest {
