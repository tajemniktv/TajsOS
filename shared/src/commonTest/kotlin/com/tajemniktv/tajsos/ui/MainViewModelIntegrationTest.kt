...
class MainViewModelIntegrationTest {
    ...
    @Test
    fun searchResults_updatesWhenFiltersChange(): TestResult = runTest(testDispatcher) {
    ...
    @Test
    fun searchResults_updatesWhenQueryChanges(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
    ...
    @Test
    fun updateNodeStatus_done_createsRecurringCopy(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
        val now =
    ...
    @Test
    fun archiveNode_updatesStatusToArchived(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
        val nodeId =
            nodeDao.insertNode(
    ...
    @Test
    fun splitNote_createsOneNodePerSection(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
        val content =
            "# First Section\nFirst content\n# Second Section\nSecond content\n# Third Section\nThird content"
    ...
    @Test
    fun splitNote_usesHeaderAsTitle(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
        val content = "# Alpha\nAlpha body\n# Beta\nBeta body"
        val originalId =
    ...
    @Test
    fun splitNote_archivesOriginalNode(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
    ...
    @Test
    fun splitNote_doesNotSplitWhenOnlyOneSection(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
    ...
    @Test
    fun splitNote_inheritsProjectAndAreaFromOriginal(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
        val projectId = 10L
        val areaId = 20L
        val content = "# Part A\nContent A\n# Part B\nContent B"
    ...
    @Test
    fun splitNote_doesNotSplitWhenNodeHasNoContent(): TestResult = runTest(testDispatcher) {
        val nodeDao = FakeNodeDao()
