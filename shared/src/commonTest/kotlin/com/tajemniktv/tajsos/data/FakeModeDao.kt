...
class FakeModeDao : ModeDao {
    ...
    override suspend fun updateMode(mode: ModeEntity) {}
    ...
    override suspend fun deactivateLog(id: Long, timestamp: Long) {}
}
