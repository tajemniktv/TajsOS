...
import com.tajemniktv.tajos.data.ModeAreaFilterEntity
import com.tajemniktv.tajos.data.ModeTypeFilterEntity
...
) : com.tajemniktv.tajos.data.ModeDao by FakeModeDao() {
...
class MainStateAssemblersDashboardTest {
    ...
    fun `buildDashboardUIState foundational notes filtering`() = runTest {
        ...
        val noteWithPin = NodeWithPin(
            node = note,
            pin = null,
            tags = listOf(com.tajemniktv.tajos.data.TagEntity(id = 1L, name = "foundational", normalizedName = "foundational", color = null))
        )
