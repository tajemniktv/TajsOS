...
class MainProtocolHelpersTest {
    ...
    fun testFindProtocolTemplate() {
        val t1 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("morning_startup", "Morning Startup", emptyList())
        val t2 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("before_sleep", "Before Sleep", emptyList())
    ...
    fun testFindPlaybookTemplate() {
        val t1 = com.tajemniktv.tajos.ui.main.state.PlaybookTemplate("exam_prep", "Exam Prep", emptyList())
        val t2 = com.tajemniktv.tajos.ui.main.state.PlaybookTemplate("project_kickoff", "Project Kickoff", emptyList())
        val templates = listOf(t1, t2)
    ...
    fun testBuildProtocolChecklistContent() {
        val template = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate(
            key = "test",
            label = "Test Protocol",
    ...
    fun testRecommendProtocolLabel() {
        val t1 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("morning_startup", "Morning Startup", emptyList())
        val t2 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("before_class", "Before Class", emptyList())
        val t3 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("deep_work_entry", "Deep Work", emptyList())
        val t4 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("work_to_rest", "Work to Rest", emptyList())
        val t5 = com.tajemniktv.tajos.ui.main.state.TransitionProtocolTemplate("before_sleep", "Before Sleep", emptyList())
