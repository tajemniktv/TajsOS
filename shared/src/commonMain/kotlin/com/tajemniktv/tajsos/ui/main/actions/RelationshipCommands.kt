...
class RelationshipCommands(
    ...
    /**
     * Attaches an important relationship date (e.g., birthday, anniversary) to a person.
     */
    ...
    /**
     * Records personal notes regarding the social energy required or generated by interacting with this person.
     */
    ...
    /**
     * Sets contextual boundaries or relationship definition strings for a person.
     */
    ...
    /**
     * Flags this person as a core or otherwise important relationship within the system.
     */
    ...
    /**
     * Classifies the relationship into a specific type (e.g., family, colleague, friend).
     */
    ...
    /**
     * Creates a many-to-many linkage between a person node and any other life object.
     */
    ...
    /**
     * Removes a pre-existing link between a person node and another life object.
     */
    ...
    /**
     * Spawns an actionable task indicating a pending reply is owed to this person.
     */
    ...
    /**
     * Spawns a collaborative or shared plan task linked to this person.
     */
    ...
    /**
     * Spawns a note to prompt the user about specific topics the next time they speak to this person.
     */
    ...
    /**
     * Creates a new place anchor node for geographic logistical management.
     */
    fun addPlace(
        title: String,
    ...
    /**
     * Links an actionable task or context to a specific physical place.
     */
    fun linkNodeToPlace(
        nodeId: Long,
        placeId: Long,
    ...
    /**
     * Removes the logistical link between a node and a physical place.
     */
    ...
    /**
     * Scaffolds a 'what to bring' preparation list for a specific location or context.
     */
    ...
    /**
     * Scaffolds a standardized packing list for travel or extended stays.
     */
    ...
    /**
     * Scaffolds a checklist of things to verify immediately prior to leaving home.
     */
    ...
    /**
     * Scaffolds a reminder set of critical items that absolutely must not be forgotten.
     */
    ...
    /**
     * Scaffolds a comprehensive preparation task list for a specific event.
     */
    ...
    /**
     * Scaffolds a student-oriented list of items required for a specific class or lecture.
     */
    ...
    /**
     * Idempotently creates or updates a reusable travel pack template note.
     */
    ...
    /**
     * Creates an unstructured reference note related to physical logistics and bounds it to an optional context.
     */
    ...
    /**
     * Captures a new personal rule or operating principle for life direction.
     */
    fun addPersonalRule(
        title: String,
        content: String = "",
    ...
    /**
     * Pins an operating principle to maintain high visibility in the rules snapshot.
     */
    ...
    /**
     * Associates a life principle with a specific behavioral playbook.
     */
    ...
    /**
     * Removes an established association between a life principle and a playbook.
     */
    ...
    /**
     * Stores a new vault entry for sensitive or highly critical structured reference data.
     */
    fun addVaultEntry(
        categoryTag: String,
        title: String,
    ...
    /**
     * Creates a tracking node for a pending application (e.g., job, housing) state.
     */
    ...
    /**
     * Flags an entry indicating it is critical to locate or resolve at a later undetermined time.
     */
