...
import com.tajemniktv.tajos.data.ProjectState
import com.tajemniktv.tajos.data.projectStateOrNull
import com.tajemniktv.tajos.ui.AreaHealthMetrics
...
internal fun AreasMainBlock(
    ...
    Column(
        ...
        if (areas.isEmpty()) {
            ...
            val overloadedCount =
                areaSnapshot.areas.count { it.status == "overloaded" || it.status == "on_fire" }
        ...
        Column(
            ...
            Row(
                ...
                SummaryChip(
                    ...
                    stringResource(Res.string.areas_dominant),
                    dominantArea,
                )
                SummaryChip(
                    Icons.AutoMirrored.Filled.TrendingUp,
                    stringResource(Res.string.areas_balance),
                    "$balanceLabel ($balanceScore)",
                )
                SummaryChip(
                    Icons.Default.Warning,
                    stringResource(Res.string.areas_neglected),
                    neglectedCount.toString(),
                )
                SummaryChip(
                    Icons.Default.Speed,
                    stringResource(Res.string.areas_load),
                    ...
                    Box(
                        modifier =
                            Modifier
                                .weight(weight)
                                .fillMaxHeight()
                                .background(color.copy(alpha = 0.6f), RoundedCornerShape(6.dp)),
