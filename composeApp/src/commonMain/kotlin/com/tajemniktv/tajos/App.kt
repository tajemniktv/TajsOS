...
import com.tajemniktv.tajos.data.StableList
import com.tajemniktv.tajos.data.TemplateEntity
import com.tajemniktv.tajos.data.toStableList
import com.tajemniktv.tajos.ui.DetailNavigationContract
import com.tajemniktv.tajos.ui.LocalMainViewModel
import com.tajemniktv.tajos.ui.MainViewModel
import com.tajemniktv.tajos.ui.Screen
import com.tajemniktv.tajos.ui.components.common.CaptureSheet
import com.tajemniktv.tajos.ui.components.common.mouseButtons
import com.tajemniktv.tajos.ui.components.layout.AppShell
import com.tajemniktv.tajos.ui.components.layout.rememberAppShellState
import com.tajemniktv.tajos.ui.components.screen.LocalScreenHeaderController
import com.tajemniktv.tajos.ui.components.screen.rememberScreenHeaderController
import com.tajemniktv.tajos.ui.screens.calendar.CalendarSettingsRoute
import com.tajemniktv.tajos.ui.screens.notes.detail.NoteDetailScreen
import com.tajemniktv.tajos.ui.screens.tasks.TasksTab
import com.tajemniktv.tajos.ui.screens.templates.TemplatesScreen
                        ...
                        Box(modifier = Modifier.fillMaxSize()) {
                            ...
                            NavHost(
                                ...
                                composable(Screen.Briefing.route) {
                                    com.tajemniktv.tajos.ui.screens.briefing.BriefingRoute(
                                        onNavigate = navigate,
                                        onNewEntry = { showCaptureSheetState = true },
                                    )
                                }
                                composable(Screen.Dashboard.route) {
                                    com.tajemniktv.tajos.ui.screens.dashboard.DashboardRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                ...
                                composable(Screen.Inbox.route) {
                                    com.tajemniktv.tajos.ui.screens.inbox.InboxRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Search.route) {
                                    com.tajemniktv.tajos.ui.screens.search.SearchRoute(
                                        viewModel = mainViewModel,
                                ...
                                composable(Screen.Today.route) {
                                    com.tajemniktv.tajos.ui.screens.today.TodayRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Focus.route) {
                                    com.tajemniktv.tajos.ui.screens.focus.FocusRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                composable(Screen.Track.route) {
                                    com.tajemniktv.tajos.ui.screens.track.TrackRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                Screen.Tasks.children.forEach {
                                    composable(it.route) {
                                        ...
                                        com.tajemniktv.tajos.ui.screens.tasks.TasksRoute(
                                            viewModel = mainViewModel,
                                            onEditNode = onEditNode,
                                            onNavigate = navigate,
                                            currentTab = tab,
                                ...
                                composable(Screen.Notes.route) {
                                    com.tajemniktv.tajos.ui.screens.notes.NotesRoute(
                                        viewModel = mainViewModel,
                                ...
                                composable(Screen.Calendar.route) {
                                    com.tajemniktv.tajos.ui.screens.calendar.CalendarRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Decisions.route) {
                                    com.tajemniktv.tajos.ui.screens.decisions.DecisionsRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.OpenLoops.route) {
                                    com.tajemniktv.tajos.ui.screens.openloops.OpenLoopsRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Protocols.route) {
                                    com.tajemniktv.tajos.ui.screens.protocols.ProtocolsRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.TimeArchitecture.route) {
                                    com.tajemniktv.tajos.ui.screens.timearchitecture.TimeArchitectureRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Places.route) {
                                    com.tajemniktv.tajos.ui.screens.places.PlacesRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Finances.route) {
                                    com.tajemniktv.tajos.ui.screens.finance.FinancesRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Health.route) {
                                    com.tajemniktv.tajos.ui.screens.health.HealthRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Relationships.route) {
                                    com.tajemniktv.tajos.ui.screens.relationships.RelationshipsRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Education.route) {
                                    com.tajemniktv.tajos.ui.screens.study.StudyRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Rules.route) {
                                    com.tajemniktv.tajos.ui.screens.rules.RulesRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Vaults.route) {
                                    com.tajemniktv.tajos.ui.screens.vaults.VaultsRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Capacity.route) {
                                    com.tajemniktv.tajos.ui.screens.capacity.CapacityRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                composable(Screen.Identity.route) {
                                    com.tajemniktv.tajos.ui.screens.identity.IdentityRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Settings.route) {
                                    com.tajemniktv.tajos.ui.screens.settings.SettingsRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                ...
                                composable(Screen.Projects.route) {
                                    com.tajemniktv.tajos.ui.screens.projects.ProjectsRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                composable(Screen.Areas.route) {
                                    com.tajemniktv.tajos.ui.screens.areas.AreasRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
                                    )
                                }
                                composable(Screen.ProjectDetail.route) {
                                    val projectId =
                                        it.savedStateHandle
                                            ...
                                            ?.toString()
                                            ?.toLongOrNull() ?: -1L
                                    com.tajemniktv.tajos.ui.screens.projects.detail.ProjectDetailRoute(
                                        viewModel = mainViewModel,
                                        projectId = projectId,
                                        onEditNode = onEditNode,
                                ...
                                composable(Screen.AreaDetail.route) {
                                    val areaId =
                                        it.savedStateHandle
                                            ...
                                            ?.toString()
                                            ?.toLongOrNull() ?: -1L
                                    com.tajemniktv.tajos.ui.screens.areas.detail.AreaDetailRoute(
                                        viewModel = mainViewModel,
                                        areaId = areaId,
                                        onNavigateToProject = { projectId ->
                                            navigate(
                                ...
                                composable(Screen.TaskDetail.route) {
                                    val taskId =
                                        it.savedStateHandle
                                            ...
                                            ?.toString()
                                            ?.toLongOrNull() ?: -1L
                                    com.tajemniktv.tajos.ui.screens.tasks.detail.TaskDetailRoute(
                                        viewModel = mainViewModel,
                                        taskId = taskId,
                                        onBack = { navController.popBackStack() },
                                        onNavigateToNode = onEditNode,
                                ...
                                composable(Screen.RecordDetail.route) {
                                    val recordId =
                                        it.savedStateHandle
                                            ...
                                            ?.toString()
                                            ?.toLongOrNull() ?: -1L
                                    com.tajemniktv.tajos.ui.screens.records.detail.RecordDetailRoute(
                                        viewModel = mainViewModel,
                                        recordId = recordId,
                                        onBack = { navController.popBackStack() },
                                        onNavigateToNode = onEditNode,
                                ...
                                composable(Screen.Insights.route) {
                                    com.tajemniktv.tajos.ui.screens.insights.InsightsRoute(
                                        viewModel = mainViewModel,
                                        onNavigateToProject = { projectId ->
                                            navigate(
                                                Screen.ProjectDetail.route.replace(
                                ...
                                composable(Screen.Graph.route) {
                                    com.tajemniktv.tajos.ui.screens.graph.GraphRoute(
                                        viewModel = mainViewModel,
                                ...
                                composable(Screen.Archive.route) {
                                    com.tajemniktv.tajos.ui.screens.archive.ArchiveRoute(
                                        viewModel = mainViewModel,
                                        onEditNode = onEditNode,
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Review.route) {
                                    com.tajemniktv.tajos.ui.screens.review.ReviewRoute(
                                        viewModel = mainViewModel,
                                        onBack = { navController.popBackStack() },
                                        onNavigate = navigate,
                                    )
                                ...
                                composable(Screen.Profile.route) {
                                    com.tajemniktv.tajos.ui.screens.profile.ProfileRoute(
                                        viewModel = mainViewModel,
                                        onNavigate = navigate,
