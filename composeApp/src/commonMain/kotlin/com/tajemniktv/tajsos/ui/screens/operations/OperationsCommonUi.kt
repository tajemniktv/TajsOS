...
internal fun ProtocolCard(
    ...
    Surface(
        ...
        Column(
            ...
            item.lastTriggeredAt?.let { lastTriggeredAt ->
                Text(
...
@Composable
internal fun DistinctionQuestionCard(item: DistinctionQuestionState) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        color = TactileTheme.Surface,
        shape =
...
@Composable
internal fun DirectionCommitmentCard(item: DirectionCommitmentStatus) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        color = TactileTheme.Surface,
        shape =
...
@Composable
internal fun CoreShiftCriterionCard(item: CoreLifeOSShiftItem) {
    Surface(
        modifier = Modifier.fillMaxWidth(),
        color = TactileTheme.Surface,
        shape =
...
@Composable
@OptIn(ExperimentalLayoutApi::class)
internal fun PersonRelationshipCard(
