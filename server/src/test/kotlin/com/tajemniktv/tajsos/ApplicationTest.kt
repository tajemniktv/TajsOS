...
class ApplicationTest {
    ...
    fun testHealthEndpoint() = testApplication {
        ...
        val clientWithNegotiation = createClient {
    ...
    @Test
    fun testSyncEndpoint_HappyPath() = testApplication {
        application {
            module()
        }
        val clientWithNegotiation = createClient {
    ...
    @Test
    fun testSyncEndpoint_BadPayload() = testApplication {
        application {
            module()
        }
    ...
    @Test
    fun testSyncEndpoint_MissingContentType() = testApplication {
        application {
            module()
        }
        val response = client.post("/sync") {
